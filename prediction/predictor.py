...
if __name__ == '__main__':
    ...
    file_path = "devcom_capstone/data/save.csv"
    ...
    # Save the model
    regressor_ai.save_model('devcom_capstone/prediction/ai_regressor_model.pkl')
    ...
    # Save the model
    regressor_huma.save_model('devcom_capstone/prediction/huma_regressor_model.pkl')
